...
class task_gen(object, metaclass=register_obj):
	mappings={}
	mapped={}
...
def declare_chain(name='',action='',ext_in='',ext_out='',reentrant=1,color='BLUE',install=0,before=[],after=[],decider=None,rule=None,scan=None):
